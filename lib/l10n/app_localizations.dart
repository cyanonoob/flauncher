...
abstract class AppLocalizations {
  ...
  /// No description provided for @unsplashQueryLabel.
  ///
  /// In en, this message translates to:
  /// **'Search (e.g. nature)'**
  String get unsplashQueryLabel;

  /// No description provided for @unsplashErrorMessage.
  ///
  /// In en, this message translates to:
  /// **'Failed to fetch wallpaper: {error}'**
  String unsplashErrorMessage(String error);

  /// No description provided for @dateFormatSpecifier_d.
  ///
  /// In en, this message translates to:
  /// **'[d] Day in month (10)'**
  String get dateFormatSpecifier_d;

  /// No description provided for @dateFormatSpecifier_E.
  ///
  /// In en, this message translates to:
  /// **'[E] Abbreviated day of week (Tue)'**
  String get dateFormatSpecifier_E;

  /// No description provided for @dateFormatSpecifier_EEEE.
  ///
  /// In en, this message translates to:
  /// **'[EEEE] Day of week (Tuesday)'**
  String get dateFormatSpecifier_EEEE;
  ...
  /// No description provided for @dateFormatSpecifier_M.
  ///
  /// In en, this message translates to:
  /// **'[M] Month in year (07)'**
  String get dateFormatSpecifier_M;

  /// No description provided for @dateFormatSpecifier_MMM.
  ///
  /// In en, this message translates to:
  /// **'[MMM] Abbreviated month in year (Jul)'**
  String get dateFormatSpecifier_MMM;

  /// No description provided for @dateFormatSpecifier_MMMM.
  ///
  /// In en, this message translates to:
  /// **'[MMMM] Month in year (July)'**
  String get dateFormatSpecifier_MMMM;

  /// No description provided for @dateFormatSpecifier_y.
  ///
  /// In en, this message translates to:
  /// **'[y] Year (1996)'**
  String get dateFormatSpecifier_y;

  /// No description provided for @timeFormatSpecifier_h.
  ///
  /// In en, this message translates to:
  /// **'[h] Hour in am/pm (1~12)'**
  String get timeFormatSpecifier_h;
  ...
  /// No description provided for @timeFormatSpecifier_m.
  ///
  /// In en, this message translates to:
  /// **'[m] Minute in hour (30)'**
  String get timeFormatSpecifier_m;

  /// No description provided for @timeFormatSpecifier_s.
  ///
  /// In en, this message translates to:
  /// **'[s] Second in minute (55)'**
  String get timeFormatSpecifier_s;

  /// No description provided for @timeFormatSpecifier_a.
  ///
  /// In en, this message translates to:
  /// **'[a] am/pm marker (PM)'**
  String get timeFormatSpecifier_a;

  /// No description provided for @timeFormatSpecifier_k.
  ///
  /// In en, this message translates to:
  /// **'[k] Hour in day (1~24)'**
  String get timeFormatSpecifier_k;
