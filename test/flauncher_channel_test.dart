...
void main() {
  ...
  test("getApplications", () async {
    final channel = MethodChannel('com.geert.flauncher/method');
  ...
  test("launchApp", () async {
    ...
    await fLauncherChannel.launchApp("com.geert.flauncher");

    expect(packageName, "com.geert.flauncher");
  });
  ...
  test("openAppInfo", () async {
    ...
    await fLauncherChannel.openAppInfo("com.geert.flauncher");
  ...
  test("uninstallApp", () async {
    ...
    await fLauncherChannel.uninstallApp("com.geert.flauncher");
